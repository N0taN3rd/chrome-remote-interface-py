...
from cripy.chrome.coverage import Coverage
from cripy.chrome.dialog import Dialog
from cripy.chrome.element_handle import ElementHandle  # noqa: F401
from cripy.chrome.emulation_manager import EmulationManager
from cripy.chrome.errors import PageError
from cripy.chrome.execution_context import JSHandle  # noqa: F401
from cripy.chrome.frame_manager import Frame  # noqa: F401
from cripy.chrome.frame_manager import FrameManager
from cripy.chrome.input import Keyboard, Mouse, Touchscreen
from cripy.chrome.navigator_watcher import NavigatorWatcher
from cripy.chrome.network_manager import NetworkManager, Response, Request
from cripy.chrome.tracing import Tracing
from cripy.chrome.util import merge_dict

if TYPE_CHECKING:
    from cripy.chrome import Target  # noqa: F401
...
class Page(EventEmitter):
    ...
    def __init__(
        ...
        client.on(
            "Security.certificateError", lambda event: self._onCertificateError(event)
        )
...
class ConsoleMessage(object):
    ...
    def __init__(self, type: str, text: str, args: List[str]) -> None:
