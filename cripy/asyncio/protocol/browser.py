...
--enable-automation is on the commandline.
    ...
    async def getHistograms(self, query: Optional[str] = None, delta: Optional[bool] = None) -> Optional[dict]:
        """
    ...
    async def getHistogram(self, name: str, delta: Optional[bool] = None) -> Optional[dict]:
        """
