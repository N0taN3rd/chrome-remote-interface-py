...
attribute, user, password.
    ...
    def dataReceived(self, fn, once=False) -> None:
        """
    ...
    def eventSourceMessageReceived(self, fn, once=False) -> None:
        """
    ...
    def loadingFailed(self, fn, once=False) -> None:
        """
    ...
    def loadingFinished(self, fn, once=False) -> None:
        """
    ...
    def requestIntercepted(self, fn, once=False) -> None:
        """
    ...
    def requestServedFromCache(self, fn, once=False) -> None:
        """
    ...
    def requestWillBeSent(self, fn, once=False) -> None:
        """
    ...
    def resourceChangedPriority(self, fn, once=False) -> None:
        """
    ...
    def signedExchangeReceived(self, fn, once=False) -> None:
        """
    ...
    def responseReceived(self, fn, once=False) -> None:
        """
    ...
    def webSocketClosed(self, fn, once=False) -> None:
        """
    ...
    def webSocketCreated(self, fn, once=False) -> None:
        """
    ...
    def webSocketFrameError(self, fn, once=False) -> None:
        """
    ...
    def webSocketFrameReceived(self, fn, once=False) -> None:
        """
    ...
    def webSocketFrameSent(self, fn, once=False) -> None:
        """
    ...
    def webSocketHandshakeResponseReceived(self, fn, once=False) -> None:
        """
    ...
    def webSocketWillSendHandshakeRequest(self, fn, once=False) -> None:
        """
