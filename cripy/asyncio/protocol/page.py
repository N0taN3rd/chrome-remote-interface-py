...
https://github.com/WICG/web-lifecycle/
    ...
    def domContentEventFired(self, fn, once=False) -> None:
        if once:
            self.chrome.once("Page.domContentEventFired", fn)
        else:
            self.chrome.on("Page.domContentEventFired", fn)

    def frameAttached(self, fn, once=False) -> None:
        """
    ...
    def frameClearedScheduledNavigation(self, fn, once=False) -> None:
        """
    ...
    def frameDetached(self, fn, once=False) -> None:
        """
    ...
    def frameNavigated(self, fn, once=False) -> None:
        """
    ...
    def frameResized(self, fn, once=False) -> None:
        if once:
            self.chrome.once("Page.frameResized", fn)
        else:
            self.chrome.on("Page.frameResized", fn)

    def frameScheduledNavigation(self, fn, once=False) -> None:
        """
    ...
    def frameStartedLoading(self, fn, once=False) -> None:
        """
    ...
    def frameStoppedLoading(self, fn, once=False) -> None:
        """
    ...
    def interstitialHidden(self, fn, once=False) -> None:
        """
    ...
    def interstitialShown(self, fn, once=False) -> None:
        """
    ...
    def javascriptDialogClosed(self, fn, once=False) -> None:
        """
    ...
    def javascriptDialogOpening(self, fn, once=False) -> None:
        """
    ...
    def lifecycleEvent(self, fn, once=False) -> None:
        """
    ...
    def loadEventFired(self, fn, once=False) -> None:
        if once:
            self.chrome.once("Page.loadEventFired", fn)
        else:
            self.chrome.on("Page.loadEventFired", fn)

    def navigatedWithinDocument(self, fn, once=False) -> None:
        """
    ...
    def screencastFrame(self, fn, once=False) -> None:
        """
    ...
    def screencastVisibilityChanged(self, fn, once=False) -> None:
        """
    ...
    def windowOpen(self, fn, once=False) -> None:
        """
