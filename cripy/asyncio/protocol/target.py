...
class Target(object):
    ...
    async def attachToTarget(self, targetId: str, flatten: Optional[bool] = None) -> Optional[dict]:
        """
...
`true`.
    ...
    def attachedToTarget(self, fn, once=False) -> None:
        """
    ...
    def detachedFromTarget(self, fn, once=False) -> None:
        """
    ...
    def receivedMessageFromTarget(self, fn, once=False) -> None:
        """
    ...
    def targetCreated(self, fn, once=False) -> None:
        """
    ...
    def targetDestroyed(self, fn, once=False) -> None:
        """
    ...
    def targetInfoChanged(self, fn, once=False) -> None:
        """
