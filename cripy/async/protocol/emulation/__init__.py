...
from cripy.async.protocol.emulation import events as Events
from cripy.async.protocol.emulation import types as Types
...
class Emulation(object):
    ...
    async def setDocumentCookieDisabled(self, disabled: bool) -> Optional[dict]:
        ...
        mayberes = await self.chrome.send(
            "Emulation.setDocumentCookieDisabled", msg_dict
        )
        return mayberes
