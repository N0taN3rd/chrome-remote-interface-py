...
class DatabaseT(object):
    ...
    @staticmethod
    def safe_create(init: Optional[dict]) -> Optional[Union['DatabaseT', dict]]:
        """
    ...
    @staticmethod
    def safe_create_from_list(init: Optional[List[dict]]) -> Optional[List[Union['DatabaseT', dict]]]:
        """
