...
from cripy.async.protocol.emulation import types as Emulation
from cripy.async.protocol.page import events as Events
from cripy.async.protocol.page import types as Types
...
https://github.com/WICG/web-lifecycle/
    ...
    def get_event_classes() -> Optional[dict]:
        ...
        """
        return Events.PAGE_EVENTS_TO_CLASS
