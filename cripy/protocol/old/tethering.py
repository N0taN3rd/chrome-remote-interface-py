...
class Tethering(PayloadMixin):
    ...
    @classmethod
    def bind(cls, port: Union["int"]):
        """Request browser port binding.
        :param port: Port number to bind.
        :type port: int
        """
        return (cls.build_send_payload("bind", {"port": port}), None)

    @classmethod
    def unbind(cls, port: Union["int"]):
        """Request browser port unbinding.
        :param port: Port number to unbind.
        :type port: int
        """
        return (cls.build_send_payload("unbind", {"port": port}), None)
...
class AcceptedEvent(BaseEvent):
    ...
    def __init__(self, port: Union["int", dict], connectionId: Union["str", dict]):
