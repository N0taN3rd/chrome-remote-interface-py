...
ResourcePriority = TypeVar("ResourcePriority", str, str)
"""Loading priority of a resource request."""

RequestId = TypeVar("RequestId", str, str)
"""Unique request identifier."""

MonotonicTime = TypeVar("MonotonicTime", float, float)
"""Monotonically increasing time in seconds since an arbitrary point in the past."""

LoaderId = TypeVar("LoaderId", str, str)
"""Unique loader identifier."""

InterceptionStage = TypeVar("InterceptionStage", str, str)
"""Stages of the interception to begin intercepting. Request will intercept before the request is sent. Response will intercept after the response is received."""

InterceptionId = TypeVar("InterceptionId", str, str)
"""Unique intercepted request identifier."""

ErrorReason = TypeVar("ErrorReason", str, str)
"""Network level fetch failure reason."""

CookieSameSite = TypeVar("CookieSameSite", str, str)
