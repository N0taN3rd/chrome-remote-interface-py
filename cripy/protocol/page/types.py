...
ScriptIdentifier = TypeVar("ScriptIdentifier", str, str)
"""Unique script identifier."""

ResourceType = TypeVar("ResourceType", str, str)
"""Resource type as it was perceived by the rendering engine."""

FrameId = TypeVar("FrameId", str, str)
"""Unique frame identifier."""

DialogType = TypeVar("DialogType", str, str)
