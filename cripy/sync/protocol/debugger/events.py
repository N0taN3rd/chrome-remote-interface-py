...
try:
    from cripy.sync.protocol.debugger.types import *
except ImportError:
    pass
...
class PausedEvent(object):
    ...
    def __init__(self, callFrames, reason, data, hitBreakpoints, asyncStackTrace, asyncStackTraceId, asyncCallStackTraceId):
        """
...
class ScriptFailedToParseEvent(object):
    ...
    def __init__(self, scriptId, url, startLine, startColumn, endLine, endColumn, executionContextId, hash, executionContextAuxData, sourceMapURL, hasSourceURL, isModule, length, stackTrace):
        """
...
class ScriptParsedEvent(object):
    ...
    def __init__(self, scriptId, url, startLine, startColumn, endLine, endColumn, executionContextId, hash, executionContextAuxData, isLiveEdit, sourceMapURL, hasSourceURL, isModule, length, stackTrace):
        """
        :param scriptId: Identifier of the script parsed.
        :type scriptId: str
        :param url: URL or name of the script parsed (if any).
