...
class ShorthandEntry(object):
    def __init__(self, name, value, important):
        """
...
class MediaQueryExpression(object):
    ...
    def __init__(self, value, unit, feature, valueRange, computedLength):
        """
...
class InheritedStyleEntry(object):
    ...
    def __init__(self, matchedCSSRules, inlineStyle):
        """
...
class CSSStyleSheetHeader(object):
    ...
    def __init__(self, styleSheetId, frameId, sourceURL, origin, title, disabled, isInline, startLine, startColumn, length, sourceMapURL, ownerNode, hasSourceURL):
        """
...
class CSSStyle(object):
    ...
    def __init__(self, cssProperties, shorthandEntries, styleSheetId, cssText, range):
        """
        :param styleSheetId: The css style sheet identifier (absent for user agent stylesheet and user-specified stylesheet rules) this rule came from.
...
class CSSRule(object):
    ...
    def __init__(self, selectorList, origin, style, styleSheetId, media):
        """
        :param styleSheetId: The css style sheet identifier (absent for user agent stylesheet and user-specified stylesheet rules) this rule came from.
        :type styleSheetId: Optional[str]
...
class CSSProperty(object):
    ...
    def __init__(self, name, value, important, implicit, text, parsedOk, disabled, range):
        """
...
class CSSMedia(object):
    ...
    def __init__(self, text, source, sourceURL, range, styleSheetId, mediaList):
        """
...
class CSSKeyframeRule(object):
    ...
    def __init__(self, origin, keyText, style, styleSheetId):
        """
        :param styleSheetId: The css style sheet identifier (absent for user agent stylesheet and user-specified stylesheet rules) this rule came from.
        :type styleSheetId: Optional[str]
        :param origin: Parent stylesheet's origin.
