...
try:
    from cripy.sync.protocol.network.types import *
except ImportError:
    pass
...
class LoadingFailedEvent(object):
    ...
    def __init__(self, requestId, timestamp, type, errorText, canceled, blockedReason):
        """
        :param requestId: Request identifier.
        :type requestId: str
        :param timestamp: Timestamp.
...
class LoadingFinishedEvent(object):
    ...
    def __init__(self, requestId, timestamp, encodedDataLength, shouldReportCorbBlocking):
        """
        :param requestId: Request identifier.
        :type requestId: str
        :param timestamp: Timestamp.
...
class RequestInterceptedEvent(object):
    ...
    def __init__(self, interceptionId, request, frameId, resourceType, isNavigationRequest, isDownload, redirectUrl, authChallenge, responseErrorReason, responseStatusCode, responseHeaders):
        """
...
class RequestWillBeSentEvent(object):
    ...
    def __init__(self, requestId, loaderId, documentURL, request, timestamp, wallTime, initiator, redirectResponse, type, frameId, hasUserGesture):
        """
        :param requestId: Request identifier.
        :type requestId: str
...
class ResponseReceivedEvent(object):
    ...
    def __init__(self, requestId, loaderId, timestamp, type, response, frameId):
        """
        :param requestId: Request identifier.
        :type requestId: str
        :param loaderId: Loader identifier. Empty string if the request is fetched from worker.
...
class WebSocketCreatedEvent(object):
    ...
    def __init__(self, requestId, url, initiator):
        """
        :param requestId: Request identifier.
        :type requestId: str
