...
class WebSocketResponse(object):
    ...
    def __init__(self, status, statusText, headers, headersText, requestHeaders, requestHeadersText):
        """
...
https://wicg.github.io/webpackage/draft-yasskin-httpbis-origin-signed-exchanges-impl.html#rfc.section.3.1
    ...
    def __init__(self, label, signature, integrity, validityUrl, date, expires, certUrl, certSha256, certificates):
        """
...
class SignedExchangeInfo(object):
    ...
    def __init__(self, outerResponse, header, securityDetails, errors):
        """
...
class SignedExchangeError(object):
    ...
    def __init__(self, message, signatureIndex, errorField):
        """
...
class SecurityDetails(object):
    ...
    def __init__(self, protocol, keyExchange, cipher, certificateId, subjectName, sanList, issuer, validFrom, validTo, signedCertificateTimestampList, certificateTransparencyCompliance, keyExchangeGroup, mac):
        """
...
class Response(object):
    ...
    def __init__(self, url, status, statusText, headers, mimeType, connectionReused, connectionId, encodedDataLength, securityState, headersText, requestHeaders, requestHeadersText, remoteIPAddress, remotePort, fromDiskCache, fromServiceWorker, timing, protocol, securityDetails):
        """
...
class RequestPattern(object):
    ...
    def __init__(self, urlPattern, resourceType, interceptionStage):
        """
...
class Request(object):
    ...
    def __init__(self, url, method, headers, initialPriority, referrerPolicy, urlFragment, postData, hasPostData, mixedContentType, isLinkPreload):
        """
...
class Initiator(object):
    ...
    def __init__(self, type, stack, url, lineNumber):
        """
...
class CookieParam(object):
    ...
    def __init__(self, name, value, url, domain, path, secure, httpOnly, sameSite, expires):
        """
...
class Cookie(object):
    ...
    def __init__(self, name, value, domain, path, expires, size, httpOnly, secure, session, sameSite):
        """
        :param name: Cookie name.
        :type name: str
        :param value: Cookie value.
...
class CachedResource(object):
    ...
    def __init__(self, url, type, bodySize, response):
        """
...
class AuthChallenge(object):
    ...
    def __init__(self, origin, scheme, realm, source):
        """
