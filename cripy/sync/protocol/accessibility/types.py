...
class AXValueSource(object):
    ...
    def __init__(self, type, value, attribute, attributeValue, superseded, nativeSource, nativeSourceValue, invalid, invalidReason):
        """
...
class AXValue(object):
    ...
    def __init__(self, type, value, relatedNodes, sources):
        """
...
class AXRelatedNode(object):
    def __init__(self, backendDOMNodeId, idref, text):
        """
...
class AXNode(object):
    ...
    def __init__(self, nodeId, ignored, ignoredReasons, role, name, description, value, properties, childIds, backendDOMNodeId):
        """
