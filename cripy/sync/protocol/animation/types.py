...
class KeyframesRule(object):
    ...
    def __init__(self, keyframes, name):
        """
...
class AnimationEffect(object):
    ...
    def __init__(self, delay, endDelay, iterationStart, iterations, duration, direction, fill, easing, backendNodeId, keyframesRule):
        """
...
class Animation(object):
    ...
    def __init__(self, id, name, pausedState, playState, playbackRate, startTime, currentTime, type, source, cssId):
        """
