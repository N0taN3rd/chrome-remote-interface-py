...
class ScreencastFrameMetadata(object):
    ...
    def __init__(self, offsetTop, pageScaleFactor, deviceWidth, deviceHeight, scrollOffsetX, scrollOffsetY, timestamp):
        """
...
class FrameTree(object):
    ...
    def __init__(self, frame, childFrames):
        """
...
class FrameResourceTree(object):
    ...
    def __init__(self, frame, resources, childFrames):
        """
        :param frame: Frame information for this tree item.
        :type frame: dict
        :param childFrames: Child frames.
...
class FrameResource(object):
    ...
    def __init__(self, url, type, mimeType, lastModified, contentSize, failed, canceled):
        """
...
class Frame(object):
    ...
    def __init__(self, id, loaderId, url, securityOrigin, mimeType, parentId, name, unreachableUrl):
        """
...
class FontSizes(object):
    ...
    def __init__(self, standard, fixed):
        """
...
class FontFamilies(object):
    ...
    def __init__(self, standard, fixed, serif, sansSerif, cursive, fantasy, pictograph):
        """
