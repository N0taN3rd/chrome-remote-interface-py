...
class LayoutTreeNode(object):
    ...
    def __init__(self, domNodeIndex, boundingBox, layoutText, inlineTextNodes, styleIndex, paintOrder):
        """
...
class DOMNode(object):
    ...
    def __init__(self, nodeType, nodeName, nodeValue, backendNodeId, textValue, inputValue, inputChecked, optionSelected, childNodeIndexes, attributes, pseudoElementIndexes, layoutNodeIndex, documentURL, baseURL, contentLanguage, documentEncoding, publicId, systemId, frameId, contentDocumentIndex, importedDocumentIndex, templateContentIndex, pseudoType, shadowRootType, isClickable, eventListeners, currentSourceURL, originURL):
        """
