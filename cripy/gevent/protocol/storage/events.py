...
from cripy.gevent.protocol.storage.types import *
...
class CacheStorageContentUpdatedEvent(object):
    ...
    def __init__(self, origin, cacheName):
        ...
        :type cacheName: str
        """
        super(CacheStorageContentUpdatedEvent, self).__init__()
        self.origin = origin
...
class CacheStorageListUpdatedEvent(object):
    ...
    def __init__(self, origin):
        ...
        :type origin: str
        """
        super(CacheStorageListUpdatedEvent, self).__init__()
        self.origin = origin
...
class IndexedDBContentUpdatedEvent(object):
    ...
    def __init__(self, origin, databaseName, objectStoreName):
        ...
        """
        super(IndexedDBContentUpdatedEvent, self).__init__()
        self.origin = origin
...
class IndexedDBListUpdatedEvent(object):
    ...
    def __init__(self, origin):
        ...
        :type origin: str
        """
        super(IndexedDBListUpdatedEvent, self).__init__()
        self.origin = origin
