...
from cripy.gevent.protocol.dom.types import *
...
class AttributeModifiedEvent(object):
    ...
    def __init__(self, nodeId, name, value):
        ...
        :type value: str
        """
        super(AttributeModifiedEvent, self).__init__()
        self.nodeId = nodeId
        self.name = name
        self.value = value
...
class AttributeRemovedEvent(object):
    ...
    def __init__(self, nodeId, name):
        ...
        :type name: str
        """
        super(AttributeRemovedEvent, self).__init__()
        self.nodeId = nodeId
        self.name = name
...
class CharacterDataModifiedEvent(object):
    ...
    def __init__(self, nodeId, characterData):
        ...
        """
        super(CharacterDataModifiedEvent, self).__init__()
        self.nodeId = nodeId
...
class ChildNodeCountUpdatedEvent(object):
    ...
    def __init__(self, nodeId, childNodeCount):
        ...
        """
        super(ChildNodeCountUpdatedEvent, self).__init__()
        self.nodeId = nodeId
...
class ChildNodeInsertedEvent(object):
    ...
    def __init__(self, parentNodeId, previousNodeId, node):
        ...
        :type node: dict
        """
        super(ChildNodeInsertedEvent, self).__init__()
...
class ChildNodeRemovedEvent(object):
    ...
    def __init__(self, parentNodeId, nodeId):
        ...
        :type nodeId: int
        """
        super(ChildNodeRemovedEvent, self).__init__()
        self.parentNodeId = parentNodeId
        self.nodeId = nodeId
...
class InlineStyleInvalidatedEvent(object):
    ...
    def __init__(self, nodeIds):
        ...
        """
        super(InlineStyleInvalidatedEvent, self).__init__()
...
class PseudoElementAddedEvent(object):
    ...
    def __init__(self, parentId, pseudoElement):
        ...
        """
        super(PseudoElementAddedEvent, self).__init__()
...
class PseudoElementRemovedEvent(object):
    ...
    def __init__(self, parentId, pseudoElementId):
        ...
        """
        super(PseudoElementRemovedEvent, self).__init__()
        self.parentId = parentId
...
class ShadowRootPoppedEvent(object):
    ...
    def __init__(self, hostId, rootId):
        ...
        :type rootId: int
        """
        super(ShadowRootPoppedEvent, self).__init__()
        self.hostId = hostId
        self.rootId = rootId
...
class ShadowRootPushedEvent(object):
    ...
    def __init__(self, hostId, root):
        ...
        :type root: dict
        """
        super(ShadowRootPushedEvent, self).__init__()
        self.hostId = hostId
