...
class DomContentEventFiredEvent(object):
    ...
    def __init__(self, timestamp):
        ...
        """
        super(DomContentEventFiredEvent, self).__init__()
...
class FrameAttachedEvent(object):
    ...
    def __init__(self, frameId, parentFrameId, stack=None):
        """
        ...
        """
        super(FrameAttachedEvent, self).__init__()
...
class FrameClearedScheduledNavigationEvent(object):
    ...
    def __init__(self, frameId):
        ...
        :type frameId: str
        """
        super(FrameClearedScheduledNavigationEvent, self).__init__()
        self.frameId = frameId
...
class FrameDetachedEvent(object):
    ...
    def __init__(self, frameId):
        ...
        :type frameId: str
        """
        super(FrameDetachedEvent, self).__init__()
        self.frameId = frameId
...
class FrameNavigatedEvent(object):
    ...
    def __init__(self, frame):
        ...
        :type frame: dict
        """
        super(FrameNavigatedEvent, self).__init__()
...
class FrameScheduledNavigationEvent(object):
    ...
    def __init__(self, frameId, delay, reason, url):
        ...
        :type url: str
        """
        super(FrameScheduledNavigationEvent, self).__init__()
        self.frameId = frameId
        self.delay = delay
        self.reason = reason
        self.url = url
...
class FrameStartedLoadingEvent(object):
    ...
    def __init__(self, frameId):
        ...
        :type frameId: str
        """
        super(FrameStartedLoadingEvent, self).__init__()
        self.frameId = frameId
...
class FrameStoppedLoadingEvent(object):
    ...
    def __init__(self, frameId):
        ...
        :type frameId: str
        """
        super(FrameStoppedLoadingEvent, self).__init__()
        self.frameId = frameId
...
class JavascriptDialogClosedEvent(object):
    ...
    def __init__(self, result, userInput):
        ...
        :type userInput: str
        """
        super(JavascriptDialogClosedEvent, self).__init__()
        self.result = result
...
class JavascriptDialogOpeningEvent(object):
    ...
    def __init__(self, url, message, type, hasBrowserHandler, defaultPrompt=None):
        """
        ...
        """
        super(JavascriptDialogOpeningEvent, self).__init__()
        self.url = url
...
class LifecycleEventEvent(object):
    ...
    def __init__(self, frameId, loaderId, name, timestamp):
        ...
        :type timestamp: float
        """
        super(LifecycleEventEvent, self).__init__()
        self.frameId = frameId
...
class LoadEventFiredEvent(object):
    ...
    def __init__(self, timestamp):
        ...
        :type timestamp: float
        """
        super(LoadEventFiredEvent, self).__init__()
        self.timestamp = timestamp
...
class NavigatedWithinDocumentEvent(object):
    ...
    def __init__(self, frameId, url):
        ...
        :type url: str
        """
        super(NavigatedWithinDocumentEvent, self).__init__()
        self.frameId = frameId
        self.url = url
...
class ScreencastFrameEvent(object):
    ...
    def __init__(self, data, metadata, sessionId):
        ...
        :type sessionId: int
        """
        super(ScreencastFrameEvent, self).__init__()
        self.data = data
...
class ScreencastVisibilityChangedEvent(object):
    ...
    def __init__(self, visible):
        ...
        :type visible: bool
        """
        super(ScreencastVisibilityChangedEvent, self).__init__()
...
class WindowOpenEvent(object):
    ...
    def __init__(self, url, windowName, windowFeatures, userGesture):
        ...
        """
        super(WindowOpenEvent, self).__init__()
        self.url = url
