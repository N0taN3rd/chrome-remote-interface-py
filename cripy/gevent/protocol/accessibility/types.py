...
class AXValueSource(object):
    ...
    def __init__(self, type, value=None, attribute=None, attributeValue=None, superseded=None, nativeSource=None, nativeSourceValue=None, invalid=None, invalidReason=None):
        """
        ...
        """
        super(AXValueSource, self).__init__()
        self.type = type
...
class AXValue(object):
    ...
    def __init__(self, type, value=None, relatedNodes=None, sources=None):
        """
...
class AXRelatedNode(object):
    ...
    def __init__(self, backendDOMNodeId, idref=None, text=None):
        """
        ...
        """
        super(AXRelatedNode, self).__init__()
...
class AXProperty(object):
    ...
    def __init__(self, name, value):
        ...
        :type value: dict
        """
        super(AXProperty, self).__init__()
        self.name = name
        self.value = AXValue.safe_create(value)
...
class AXNode(object):
    ...
    def __init__(self, nodeId, ignored, ignoredReasons=None, role=None, name=None, description=None, value=None, properties=None, childIds=None, backendDOMNodeId=None):
        """
